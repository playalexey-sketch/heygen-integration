...
MENU_HELP_EXTRA = (
    "\n"
    "📖 Введите «/» в чате — меню всех команд с подсказками. "
    "/help — полный справочник, /setmenu — обновить меню.\n"
    "\n"
    "🔑 Ссылки и правила (куда отправлять клиентам):\n"
    "/rules — список правил и готовых ссылок\n"
    "/addrule — добавить правило (триггер → контент)\n"
    "/delrule N, /onrule N, /offrule N\n"
    "\n"
    "🎬 Медиа-файлы:\n"
    "/media — список, /upmedia — загрузить файл сообщением\n"
    "\n"
    "🔌 Подключение к Telegram:\n"
    "/proxy — текущий прокси\n"
    "/setproxy socks5://127.0.0.1:10808 — установить (пусто = прямое)\n"
    "\n"
    "👥 CRM и рассылки:\n"
    "/crm — база клиентов (откуда пришли, теги)\n"
    "/tag ID тег, /untag ID тег\n"
    "/mail all текст | /mail tag:тег текст | /mail src:источник текст"
)
